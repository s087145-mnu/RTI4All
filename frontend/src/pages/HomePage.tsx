  ...
  return (
    <>
            ...
            <div className="relative hidden md:block">
              <div className="rounded-2xl border border-ink-200 bg-ink-50 p-6 shadow-card">
                <div className="flex items-center justify-between border-b border-ink-200 pb-3">
                  <div>
                    <div className="text-xs text-ink-500">Request</div>
                ...
                <div className="mt-4 space-y-3">
                  <div>
                    ...
                    <div className="mt-0.5 text-sm font-medium text-ink-900">
                      Coral reef bleaching monitoring data 2023
                    </div>
                  </div>
                  <div>
                    <div className="text-[11px] uppercase tracking-wider text-ink-500">
                    ...
                    <div className="mt-0.5 text-sm text-ink-700">20 Jan 2024</div>
                  </div>
                  <div className="rounded-lg border border-ink-200 bg-white px-4 py-3">
                    ...
                    <p className="mt-1 text-xs leading-relaxed text-ink-700">
                      The 2023 coral reef monitoring summary has been published
                      on the official portal. Site-level data and methodology
                      are referenced in the linked monitoring report.
                    </p>
                  </div>
                </div>
              </div>
      ...
      <Container>
        ...
        {error ? <ErrorBanner message={`Could not load stats — ${error}`} /> : null}
            ...
            {[
              {
                ...
                desc: "Submit your information request with a subject and description.",
              },
              {
                step: "02",
              ...
              },
              {
                ...
                desc: "Track the status from your dashboard. Decisions arrive within 30 days.",
              },
            ].map((s) => (
